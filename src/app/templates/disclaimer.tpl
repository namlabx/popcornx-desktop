...
<div class="disclaimer-state">
    <div class="disclaimer-content">
        ...
        <span class="dhtEnableSpn" style="display: none;">
            <input class="settings-checkbox" name="dhtEnableFR" id="dhtEnableFR" type="checkbox">
            <label class="settings-label" for="dhtEnableFR"><%= i18n.__("Enable automatically updating the API Server URLs") %></label>
        </span>
        <span class="updateNotificationSpn" style="display: none;">
            <input class="settings-checkbox" name="updateNotificationFR" id="updateNotificationFR" type="checkbox">
